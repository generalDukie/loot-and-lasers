...
// Icons are Lucide / currency ids (mirrored in Godot DungeonRules).
// ═══════════════════════════════════════════

export const DUNGEON_PLANETS = [
  {
    id: 1, name: "Verdant Expanse", icon: "earth", color: "#22C55E",
    ...
    bossName: "Tharon Brood Matriarch", bossEmoji: "bug",
  ...
  {
    id: 2, name: "Ashen Reach", icon: "house", color: "#3B82F6",
    ...
    bossName: "Warden of Ash", bossEmoji: "flame",
  ...
  {
    id: 3, name: "Shadow Veil", icon: "skull", color: "#A855F7",
    ...
    bossName: "Captain Zyrik", bossEmoji: "skull",
  ...
  {
    id: 4, name: "Shattered Expanse", icon: "tornado", color: "#F59E0B",
    ...
    bossName: "The Riftlord", bossEmoji: "tornado",
  ...
  {
    id: 5, name: "Abyssal Core", icon: "circle-dot-dashed", color: "#EF4444",
    ...
    bossName: "Void Devourer", bossEmoji: "circle-dot-dashed",
  ...
  {
    id: 6, name: "Frostfall Reach", icon: "snowflake", color: "#06B6D4",
    ...
    bossName: "Glacial Warden", bossEmoji: "cuboid",
  ...
  {
    id: 7, name: "Ember Maw", icon: "mountain", color: "#F97316",
    ...
    bossName: "Magma Titan", bossEmoji: "mountain",
  ...
  {
    id: 8, name: "Void Sanctum", icon: "circle", color: "#7C3AED",
    ...
    bossName: "The Null King", bossEmoji: "circle",
  ...
  {
    id: 9, name: "Crystal Nexus", icon: "nova", color: "#14B8A6",
    ...
    bossName: "Prism Sovereign", bossEmoji: "nova",
  ...
  {
    id: 10, name: "World Zero", icon: "orbit", color: "#FBBF24",
    ...
    bossName: "The Genesis", bossEmoji: "orbit",
