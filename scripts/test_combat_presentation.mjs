...
const events = [
  { type: "passive", kind: "phantom_signal_armed", side: "player", charges: 2 },
  { type: "passive", kind: "dirty_trick_selected", side: "opponent", dirtyTrick: "flashbang" },
  { type: "passive", kind: "astral_barrier_created", side: "player", barrier: 40, barrierMax: 40 },
  { type: "miss", missKind: "phantom_signal", kind: "phantom_signal_miss", defender: "player", chargesRemaining: 1, damage: 0 },
