          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2.5 sm:gap-3 text-center mb-4">
                ...
                <div className="p-3 rounded-xl bg-muted/25 border border-border/40">
                  <Fuel className={`w-5 h-5 mx-auto ${hoverLowFuel ? "text-amber-400" : ""}`} style={hoverLowFuel ? undefined : { color: FUEL_COLOR }} />
                  <p className={`text-lg sm:text-xl font-display font-bold mt-1.5 ${hoverLowFuel ? "text-amber-400" : ""}`} style={hoverLowFuel ? undefined : { color: FUEL_COLOR }}>{hoverFuelCost}</p>
                  <p className={`text-[10px] uppercase tracking-wide mt-0.5 ${hoverLowFuel ? "text-amber-400" : ""}`} style={hoverLowFuel ? undefined : { color: FUEL_COLOR }}>Fuel</p>
                </div>
              </div>
