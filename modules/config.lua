...
local NAMESPACE_SCHEMAS = {
  ...
  arena = {
    default_rating = { type = "integer", client_visible = true, default = 1000, min = 0, max = 5000 },
    minimum_rating = { type = "integer", client_visible = false, default = 0, min = 0, max = 5000 },
    maximum_rating = { type = "integer", client_visible = false, default = 3000, min = 100, max = 10000 },
    k_factor = { type = "integer", client_visible = false, default = 28, min = 1, max = 100 },
    rating_divisor = { type = "integer", client_visible = false, default = 400, min = 1, max = 1000 },
    maximum_gain = { type = "integer", client_visible = false, default = 32, min = 1, max = 100 },
    maximum_loss = { type = "integer", client_visible = false, default = 32, min = 1, max = 100 },
    minimum_nonzero_gain = { type = "integer", client_visible = false, default = 1, min = 0, max = 10 },
    full_gain_difference = { type = "integer", client_visible = false, default = 100, min = 0, max = 2000 },
    reduced_gain_start = { type = "integer", client_visible = false, default = 250, min = 0, max = 2000 },
    severe_reduction_start = { type = "integer", client_visible = false, default = 400, min = 0, max = 2000 },
    zero_gain_cutoff = { type = "integer", client_visible = false, default = 400, min = 0, max = 2000 },
    medium_gain_multiplier = { type = "integer", client_visible = false, default = 50, min = 0, max = 100 },
    low_gain_multiplier = { type = "integer", client_visible = false, default = 20, min = 0, max = 100 },
    matchmaking_initial_window = { type = "integer", client_visible = false, default = 120, min = 10, max = 2000 },
    matchmaking_window_step = { type = "integer", client_visible = false, default = 80, min = 10, max = 500 },
    matchmaking_max_window = { type = "integer", client_visible = false, default = 800, min = 50, max = 5000 },
    matchmaking_slots = { type = "integer", client_visible = true, default = 3, min = 1, max = 5 },
    battle_cooldown_seconds = { type = "integer", client_visible = true, default = 300, min = 0, max = 86400 },
    daily_attempt_limit = { type = "integer", client_visible = true, default = 10, min = 0, max = 100 },
    opponent_refresh_cooldown_seconds = { type = "integer", client_visible = true, default = 300, min = 0, max = 86400 },
    history_page_size = { type = "integer", client_visible = false, default = 10, min = 1, max = 50 },
    rankings_page_size = { type = "integer", client_visible = false, default = 50, min = 1, max = 100 },
    repeat_opponent_window_seconds = { type = "integer", client_visible = false, default = 86400, min = 60, max = 604800 },
    max_rated_battles_per_opponent = { type = "integer", client_visible = false, default = 3, min = 1, max = 20 },
    repeat_full_reward_matches = { type = "integer", client_visible = false, default = 1, min = 0, max = 10 },
    repeat_reduced_reward_matches = { type = "integer", client_visible = false, default = 1, min = 0, max = 10 },
    repeated_opponent_gain_multiplier = { type = "integer", client_visible = false, default = 40, min = 0, max = 100 },
    no_gain_after_repeat_count = { type = "integer", client_visible = false, default = 2, min = 0, max = 20 },
    active_season_id = { type = "string", client_visible = true, default = "", maxlen = 32 },
  },
  social = {
    maximum_friends = { type = "integer", client_visible = true, default = 200, min = 1, max = 1000 },
    maximum_pending_outgoing_requests = { type = "integer", client_visible = false, default = 50, min = 1, max = 200 },
    maximum_pending_incoming_requests = { type = "integer", client_visible = false, default = 50, min = 1, max = 200 },
    friend_request_cooldown_seconds = { type = "integer", client_visible = true, default = 5, min = 0, max = 3600 },
    friend_request_daily_limit = { type = "integer", client_visible = false, default = 50, min = 1, max = 500 },
    user_search_minimum_length = { type = "integer", client_visible = true, default = 3, min = 1, max = 32 },
  },
  chat = {
    maximum_message_length = { type = "integer", client_visible = true, default = 280, min = 1, max = 2000 },
    global_history_page_size = { type = "integer", client_visible = false, default = 50, min = 1, max = 100 },
    dm_history_page_size = { type = "integer", client_visible = false, default = 50, min = 1, max = 100 },
    history_absolute_max = { type = "integer", client_visible = false, default = 100, min = 1, max = 100 },
    global_rate_limit = { type = "integer", client_visible = false, default = 8, min = 1, max = 60 },
    dm_rate_limit = { type = "integer", client_visible = false, default = 10, min = 1, max = 60 },
    duplicate_message_window_seconds = { type = "integer", client_visible = false, default = 30, min = 1, max = 600 },
    duplicate_message_limit = { type = "integer", client_visible = false, default = 2, min = 1, max = 20 },
    minimum_message_interval_ms = { type = "integer", client_visible = false, default = 500, min = 0, max = 10000 },
  },
  mail = {
    inbox_default_page_size = { type = "integer", client_visible = true, default = 30, min = 1, max = 50 },
    inbox_maximum_page_size = { type = "integer", client_visible = false, default = 50, min = 1, max = 100 },
    maximum_subject_length = { type = "integer", client_visible = true, default = 80, min = 1, max = 200 },
    maximum_body_length = { type = "integer", client_visible = true, default = 2000, min = 1, max = 8000 },
    player_mail_rate_limit = { type = "integer", client_visible = false, default = 5, min = 1, max = 60 },
    player_mail_daily_limit = { type = "integer", client_visible = false, default = 50, min = 1, max = 500 },
    player_text_mail_retention_days = { type = "integer", client_visible = false, default = 90, min = 1, max = 3650 },
    system_mail_retention_days = { type = "integer", client_visible = false, default = 365, min = 1, max = 3650 },
    reward_mail_retention_days = { type = "integer", client_visible = false, default = 365, min = 1, max = 3650 },
    claimed_mail_retention_days = { type = "integer", client_visible = false, default = 90, min = 1, max = 3650 },
    maximum_unclaimed_attachment_mail = { type = "integer", client_visible = false, default = 100, min = 1, max = 1000 },
    attachments_claim_all_or_nothing = { type = "boolean", client_visible = false, default = true },
  },
}
...
local DEFAULT_FLAGS = {
  ...
  arena_matchmaking_enabled = {
    flag_id = "arena_matchmaking_enabled",
    enabled = true,
    environment = "development",
    client_visible = true,
    minimum_client_version = "",
  ...
  arena_direct_challenge_enabled = {
    flag_id = "arena_direct_challenge_enabled",
    enabled = true,
    environment = "development",
    client_visible = true,
    minimum_client_version = "",
  ...
  arena_rankings_enabled = {
    flag_id = "arena_rankings_enabled",
    enabled = true,
    environment = "development",
    client_visible = true,
    minimum_client_version = "",
  ...
  direct_messages_enabled = {
    flag_id = "direct_messages_enabled",
    enabled = true,
    environment = "development",
    client_visible = true,
    minimum_client_version = "",
  ...
  mail_attachments_enabled = {
    flag_id = "mail_attachments_enabled",
    enabled = true,
    environment = "development",
    client_visible = true,
    minimum_client_version = "",
