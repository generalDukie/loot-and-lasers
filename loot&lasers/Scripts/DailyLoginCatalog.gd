...
const ENTRIES: Array = [
	...
	{"day": 10, "rewards": {"collectible": {"name": "Strength Field Injector"}}},
	...
	{"day": 18, "rewards": {"collectible": {"name": "Agility Field Injector"}}},
	...
	{"day": 23, "rewards": {"collectible": {"name": "Vitality Precision Injector"}}},
