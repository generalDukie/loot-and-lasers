...
export const BUILTIN_BUTTONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Messages", icon: "✉️", to: "/messages", color: "#C084FC" },
    ],
  },
  {
    ...
    options: [{ label: "Galactic Frontier", icon: "🧭", to: "/galaxy-map", color: "#C084FC" }],
  },
  {
    id: "command_hub",
    type: "side",
    ...
    color: "#FBBF24",
    desc: "Settings & inbox",
    options: [{ label: "Command Hub", icon: "⚙️", to: "/settings", color: "#FBBF24" }],
  },
  {
    id: "bazaar",
    type: "split",
