...
const TIPS = [
  { icon: Compass, color: "#22D3EE", title: "Explore the Station", body: "Your hub is the map — tap any glowing module to travel. Cantina for quests, Crew Quarters for your character, Ship Dock for upgrades." },
