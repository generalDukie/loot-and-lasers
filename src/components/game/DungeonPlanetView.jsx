...
function EncounterCell({ idx, isBoss, isCurrent, isCleared, locked, patrol }) {
  ...
  return (
    <div
      className={`relative min-h-0 h-full overflow-hidden rounded-xl border flex flex-col items-center justify-center gap-0.5 transition-colors ${accent} ${
    ...
    >
      ...
      {isCurrent && !patrol && (
        <span className="absolute top-0.5 left-1/2 -translate-x-1/2 z-[2] text-[7px] font-display font-bold tracking-wider px-1.5 py-px rounded-full bg-primary text-primary-foreground shadow-sm">
          NEXT
        </span>
      )}
    </div>
    ...
    >
      ...
      <div className="relative z-[1] flex-1 min-h-0 flex flex-col p-3 sm:p-3.5 pb-14">
        ...
        <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 min-h-0 flex flex-col overflow-hidden rounded-xl border border-border/40 bg-background/25 p-2">
