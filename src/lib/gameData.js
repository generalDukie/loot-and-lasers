...
/**
 * Stardust cost for purchase number `n` of one attribute (1 = that stat's first bought point).
 * Authoritative helper: productionMath.permanentAttributePurchaseCost.
 * Certified attrcost Horner is unchanged; each stat's intro purchases #1–#5 precede it.
 */
