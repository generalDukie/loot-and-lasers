...
import { Skull, Crown, Swords, Gem, Lock, Check, Clock, Zap } from "lucide-react";
  ...
  return (
    <div className="painted-panel canvas-grain p-5">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div>
          <p className="text-[10px] font-display tracking-widest uppercase text-muted-foreground">{planet.id > 10 ? "∞ Infinite Depth" : `Planet ${planet.id}`}</p>
      ...
      <div className="grid grid-cols-5 gap-2 mb-4">
        {enemies.map((idx) => {
          const isBoss = idx === 10;
          const isCurrent = idx === currentEnemy;
          const isCleared = idx < currentEnemy;
          return (
            <div
              key={idx}
